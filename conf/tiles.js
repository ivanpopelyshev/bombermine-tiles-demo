...
var newSlot = function(name, attr) { return tileConf.newSlot(name, attr); }
var newItem = function(name, attr) { return tileConf.newItem(name, attr); }
var newChange = function(name, attr) { return tileConf.newChange(name, attr); }
var sub = function(name, attr) {
    if (!attr)
        attr = {};
    return tileConf.newTile(name, attr);
}
var getTile = function(name) { return tileConf.getTile(name); }
var getSlot = function(name) { return tileConf.getSlot(name); }
var getItem = function(name) { return tileConf.getItem(name); }
var getChange = function(name) { return tileConf.getChange(name); }
var getItem = function(name) { return tileConf.getItem(name); }

var BLOCK_EFFECT_SPAWN_BOMBS = 1;
var BLOCK_EFFECT_FORCE_REGEN = 2;
var BLOCK_EFFECT_DESTROY_BLOCK = 3;
var BLOCK_EFFECT_SPAWN_BOMBS_NY = 4;

var ITEM_EFFECT_CHANGE_COUNT_TO_BOMBS_PLUS_TWO = 5;
var ITEM_EFFECT_TELEPORT_FROM_STRUCTURE = 6;
var ITEM_EFFECT_RANDOM_DESEASE = 7;
var ITEM_EFFECT_XOR = 8;
var ITEM_EFFECT_BALL = 9;
var ITEM_EFFECT_SANTA_CANT_TAKE = 10;

var next = getChange("next");
